  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        {[1,2,3,4].map(i => (
          <Card key={i}><BlockStack gap="100"><div style={box("60%",14)} /><div style={box("80%",28)} /><div style={box("50%",14)} /></BlockStack></Card>
        ))}
      </div>
      {/* Chart */}
      <Card><BlockStack gap="300"><div style={box("60%",20)} /><div style={box("100%",280)} /></BlockStack></Card>
      {/* Monthly table */}
      <Card><BlockStack gap="300"><div style={box("50%",20)} /><div style={box("100%",350)} /></BlockStack></Card>
    </>
  );
}

// ─── MAIN CONTENT ─────────────────────────────────────────────────────────────
function PrevisioniContent({ data }) {
  const {
    ...
    <Page title="Previsioni">
      ...
      <BlockStack gap="500">
        <Suspense fallback={<LoadingSkeleton />}>
          <Await resolve={data}>
            {(resolved) => <PrevisioniContent data={resolved} />}
          </Await>
        </Suspense>
      </BlockStack>
    </Page>
